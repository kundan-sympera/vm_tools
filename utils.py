def wifi_reconnect():
    ...
    interface = "enp0s3"   # Make sure this matches your interface
    
    try:
        print("[NETWORK] Randomizing MAC address and reconnecting...")
        
        # Use the randmac alias we created earlier
        ...
        if result.returncode == 0:
            ...
            # Give network some time to stabilize
            time.sleep(4)
        else:
        ...
        # Fallback: simple reconnect without MAC change
        try:
